...
import com.micro.ykh.utils.DateUtils;
...
public class VelocityUtils {
    ...
    public static void setMenuVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        Map<String, String> paramsObj = getParamObject(options);
    ...
    public static void setTreeVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        if (!CollectionUtils.isEmpty(paramsObj)) {
            treeCode = getTreecode(paramsObj);
            treeParentCode = getTreeParentCode(paramsObj);
            treeName = getTreeName(paramsObj);
        }
    ...
    private static Map<String, String> getParamObject(String options) {
        ObjectMapper objectMapper = new ObjectMapper();
        JavaType javaType = objectMapper.getTypeFactory().constructMapType(Map.class, String.class, String.class);
        Map<String, String> paramObject = null;
        try {
            paramObject = objectMapper.readValue(options, javaType);
