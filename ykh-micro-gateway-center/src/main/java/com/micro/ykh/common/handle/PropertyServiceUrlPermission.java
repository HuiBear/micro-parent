...
/**
 * @ClassName PropertyServiceUrlPermission
 * @Description 物业端URL鉴权
 * @Author xiongh
 * @Date 2021/1/13 9:55
 * @Version 1.0
 **/
@Component
public class PropertyServiceUrlPermission implements UrlPermissionInterface {
    ...
    public boolean checkUrlPermission(Claims claims, String currentUrl) {
        ...
        // 假如是物业端 的获得路由和获得用户信息 数据字典的请求也直接放过
