...
/**
    * 菜单权限表
    */
@TableName(value = "pps_sys_menu")
public class PpsSysMenu {
    /**
     * 菜单ID
     */
    ...
    private List<PpsSysMenu> children;

    public List<PpsSysMenu> getChildren() {
        return children;
    }

    public void setChildren(List<PpsSysMenu> children) {
